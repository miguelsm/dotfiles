...
(let* ((class '((class color) (min-colors 89)))
       ...
       (bright-cyan "#00aacb")
       (bright-green "#60cb00")
       (bright-magenta "#e64ce6")
       (bright-red "#f05050")
       (bright-yellow "#ffbc5d")
       ;; ---
       (fg1 black)
       (fg2 "#c3c3c3")
       (fg3 "#b2b2b2")
  ...
  (custom-theme-set-faces
   ...
   `(show-paren-match ((,class (:background ,bg5))))
   `(isearch ((,class (:foreground ,warning :background ,bg3))))
   `(mode-line ((,class (:box (:line-width 1 :color nil) :foreground ,fg4 :background ,bg2))))
   ...
   `(linum ((,class (:foreground ,fg2 ))))
   `(ahs-face ((,class (:background ,bg5 :foreground nil))))
   ...
   `(magit-section-heading        ((,class (:foreground ,keyword))))
   ...
   `(helm-ff-directory ((,class (:foreground ,func :background ,bg1))))
   `(helm-ff-file ((,class (:foreground ,fg1 :background ,bg1 :weight normal))))
   `(helm-ff-executable ((,class (:foreground ,var :background ,bg1 :weight normal))))
   `(helm-ff-invalid-symlink ((,class (:foreground ,warning2 :background ,bg1))))
   `(helm-ff-symlink ((,class (:foreground ,keyword :background ,bg1))))
